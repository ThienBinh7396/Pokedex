...
import com.example.pokedexapplication.databinding.PokemonWeaknessLgBinding
import com.example.pokedexapplication.viewModel.PokemonWeaknessViewModel

class PokemonWeaknessLgAdapter :
  RecyclerView.Adapter<PokemonWeaknessLgAdapter.PokemonWeaknessViewHolder>() {

  private var mPokemonWeaknessList: MutableList<WeaknessesResponse> = mutableListOf()

  class PokemonWeaknessViewHolder(var pokemonWeaknessBinding: PokemonWeaknessLgBinding) :
